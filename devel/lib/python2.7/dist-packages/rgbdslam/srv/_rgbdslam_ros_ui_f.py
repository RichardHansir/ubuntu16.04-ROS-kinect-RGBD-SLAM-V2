...
"""autogenerated by genpy from rgbdslam/rgbdslam_ros_ui_fRequest.msg. Do not edit."""
import sys
...
class rgbdslam_ros_ui_fRequest(genpy.Message):
  _md5sum = "d8f674e014809463d0a122a49c328a89"
...
def _get_struct_f():
    ...
    return _struct_f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from rgbdslam/rgbdslam_ros_ui_fResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class rgbdslam_ros_ui_fResponse(genpy.Message):
...
def _get_struct_I():
    global _struct_I
    return _struct_I
class rgbdslam_ros_ui_f(object):
