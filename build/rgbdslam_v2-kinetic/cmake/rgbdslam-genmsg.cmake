...
get_filename_component(_filename "/home/richard/rgbdslam_ws/src/rgbdslam_v2-kinetic/srv/rgbdslam_ros_ui_s.srv" NAME_WE)
add_custom_target(_rgbdslam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rgbdslam" "/home/richard/rgbdslam_ws/src/rgbdslam_v2-kinetic/srv/rgbdslam_ros_ui_s.srv" ""
)

get_filename_component(_filename "/home/richard/rgbdslam_ws/src/rgbdslam_v2-kinetic/srv/rgbdslam_ros_ui_b.srv" NAME_WE)
add_custom_target(_rgbdslam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rgbdslam" "/home/richard/rgbdslam_ws/src/rgbdslam_v2-kinetic/srv/rgbdslam_ros_ui_b.srv" ""
)

get_filename_component(_filename "/home/richard/rgbdslam_ws/src/rgbdslam_v2-kinetic/srv/rgbdslam_ros_ui.srv" NAME_WE)
add_custom_target(_rgbdslam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rgbdslam" "/home/richard/rgbdslam_ws/src/rgbdslam_v2-kinetic/srv/rgbdslam_ros_ui.srv" ""
)

get_filename_component(_filename "/home/richard/rgbdslam_ws/src/rgbdslam_v2-kinetic/srv/rgbdslam_ros_ui_f.srv" NAME_WE)
add_custom_target(_rgbdslam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rgbdslam" "/home/richard/rgbdslam_ws/src/rgbdslam_v2-kinetic/srv/rgbdslam_ros_ui_f.srv" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rgbdslam)
  install(CODE "execute_process(COMMAND \"/home/richard/anaconda2/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rgbdslam\")")
  # install generated code
  install(
